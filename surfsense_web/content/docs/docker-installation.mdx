...
For the fastest setup experience, use our automated quick-start scripts:
...
For comprehensive deployment documentation including troubleshooting and production configurations, see:
...
If you prefer to set up manually or need more control over the configuration:
