	...
	return (
		...
		>
			...
			<p className="relative z-50 mx-auto mt-4 max-w-lg px-4 text-center text-base/6 text-gray-600 dark:text-gray-200">
				Your personal AI research assistant that connects to all your knowledge sources. Search, chat, and generate insights from your documents, integrations, and external data—all in one place.
			</p>
